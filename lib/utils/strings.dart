class FeedFoodStrings {
  ...
  // static const url = "https://feed-n-joy.000webhostapp.com"; (Hosting)
  //static const url = "http://10.0.2.2/sharemeal"; // Virtual emulator
  //static const url = "http://192.168.1.5/sharemeal"; // physical
  //static const url = "http://192.168.1.6/sharemeal"; // physical
  static const url = "http://192.168.1.4/sharemeal"; // physical
  ...
  // Pages
  static const BrandName = "ShareMeal";
}
